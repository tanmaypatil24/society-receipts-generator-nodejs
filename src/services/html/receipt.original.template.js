export function receiptTemplateOriginal(data) {
  ...
  <div class="receipt-root">
      <div class="paper">
        <div class="header">
          ...
          <div class="reg">Reg. No.: TNA / ${data?.society_registration_no}</div>
          <div class="addr">
        ...
        <div class="row">
          ...
          <div class="footer">
            <div class="for-company"> ${data?.society_name}</div>

            <div class="signs">
              <div class="sig">Chairman</div>
              <div class="sig">Hon. Secretary</div>
              <div class="sig">Treasurer</div>
            </div>
          </div>
        </div>
      </div>
